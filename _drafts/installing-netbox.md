...
Apache is set up, but since it's a reverse proxy there's not much to see until you set up the WSGI server.  Next though, allow Apache access to a media directory.
